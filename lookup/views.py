...
def home(request):
    ...
    if request.method == 'POST':
        ...
        api_request = requests.get(
            "http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=5&API_KEY=4BDBE7C2-554E-4426-9A08-F53D458E298C")
        ...
        if api[0]['Category']['Name'] == "Good":
            ...
            category_description = '(51 - 100) Air Quality is acceptable; however, for some pollutants there may be a moderate health concern for avery small number of people who are unusually sensitive to air pollution.'
        ...
        api_request = requests.get(
            "http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=20002&distance=5&API_KEY=4BDBE7C2-554E-4426-9A08-F53D458E298C")
